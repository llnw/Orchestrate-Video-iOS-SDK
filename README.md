...
2.	Add the "Library" and "Headers" folders to your project.
...
Getting all these third party libraries manually is a tedious task.
...
![Select Layout](Screenshots/Select Layout.png "Select Single View Application layout")
...
4.	Select the location where you want to save your project and click Create.
    - You can select the checkbox in front of ‘Source Control’ if you want to create a git repository for your project.

![Select project location](Screenshots/Select Layout.png "Select project location")

5.	Now close the project as we need to install pods and after that we will use the ".xcworkspace" file created by that.
...
You should see following line as the last line.
...
If you do not wish to use CocoaPods, then you can add LimelightVideoKit manually to your project by executing the following steps:

1.	Download LimelightVideoSDK for iOS from [here](https://github.llnw.net/llnw/limelight-sdk-ios/releases/tag/0.0.1).
...
4.	On the “Build Settings” tab of your application target:
    * In your project settings, make sure that LimelightVideoKit SDK headers are in your application’s “Header Search Paths”.
    * Add `–ObjC` to “Other Linker Flags”.
...
3.	Modify your ViewController implementation as given below.
    ...
    -	Define initialization method to setup sample media and library. Customer Limelight Video Account credentials and media ID should be entered into the sample block below.
